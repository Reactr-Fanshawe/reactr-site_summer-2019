...
<section id="serviceScales">
     <div id="scaleTitle">
		...
		<div class="scaleLength">
		 ...
		 <div class="timelineRow">		
			<img class="timelineSVG" src="images/serviceTimeline_short.svg" alt="project timeline">	
			<div class="timelineRowText">   
				<p class="copy">meeting</p><p class="copy">project start</p>
			</div>	
		 </div>
		</div>
     </div>
     ...
     <div class="scaleRowDiv">
		...
		<div class="scaleLength">
		 ...
		 <div class="timelineRow">		
			<img class="timelineSVG" src="images/serviceTimeline.svg" alt="project timeline">	
			<div class="timelineRowText">   
				<p class="copy">meeting</p><p class="copy">planning</p><p class="copy">project start</p>
			</div>	
		 </div>
		</div>
