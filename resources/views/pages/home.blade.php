...
<section id="offer">
	...
	<div class="content">
		...
		<div id="design" class="offer">
			<svg class="offerIcon" id="Layer_3" data-name="Layer 3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 61 54.5">
				<defs>
				<style>
				  .cls-1 {
				    fill: none;
		...
		<div id="branding" class="offer">
			...
			<svg class="offerIcon" id="Layer_4" data-name="Layer 4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 73.25 55.25">
				<defs>
				<style>
				  .cls-1 {
				    fill: none;
